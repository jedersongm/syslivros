...
public class UsuarioInforValidacao {
    ...
    public List<String> validar(String email, String nome, String apelido, String senha,
           String cidade, String estado, String foto, String data_nascimento, String tipo) {
